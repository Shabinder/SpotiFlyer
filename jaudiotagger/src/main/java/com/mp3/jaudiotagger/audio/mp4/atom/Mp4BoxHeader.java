 ...
 */
package com.mp3.jaudiotagger.audio.mp4.atom;

import com.mp3.jaudiotagger.StandardCharsets;
import com.mp3.jaudiotagger.audio.exceptions.InvalidBoxHeaderException;
...
{
    // Logger Object
    public static Logger logger = Logger.getLogger("com.mp3.jaudiotagger.audio.mp4.atom");
