 ...
 */
package com.mp3.jaudiotagger.audio.ogg.util;

import com.mp3.jaudiotagger.StandardCharsets;
import com.mp3.jaudiotagger.audio.ogg.VorbisVersion;
...
{
    // Logger Object
    public static Logger logger = Logger.getLogger("com.mp3.jaudiotagger.audio.ogg.atom");
