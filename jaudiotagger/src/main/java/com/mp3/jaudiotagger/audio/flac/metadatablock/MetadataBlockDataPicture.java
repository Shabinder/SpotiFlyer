package com.mp3.jaudiotagger.audio.flac.metadatablock;
...
public class MetadataBlockDataPicture implements MetadataBlockData, TagField
{
    ...
    // Logger Object
    public static Logger logger = Logger.getLogger("com.mp3.jaudiotagger.audio.flac.MetadataBlockDataPicture");
