...
import static com.mp3.jaudiotagger.audio.dsf.DsdChunk.CHUNKSIZE_LENGTH;
...
{
    public static Logger logger = Logger.getLogger("com.mp3.jaudiotagger.audio.dsf.FmtChunk");
     ...
     *                       fields
     * @return an empty {@link com.mp3.jaudiotagger.audio.generic.GenericAudioHeader} if audioInfoChunk has less
