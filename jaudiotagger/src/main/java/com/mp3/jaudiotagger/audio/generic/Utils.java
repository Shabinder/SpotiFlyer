...
import com.mp3.jaudiotagger.utils.FileTypeUtil;
...
import static com.mp3.jaudiotagger.StandardCharsets.ISO_8859_1;
import static com.mp3.jaudiotagger.StandardCharsets.US_ASCII;
...
public class Utils {
    ...
    private static final Logger logger = Logger.getLogger("com.mp3.jaudiotagger.audio.generic.utils");
