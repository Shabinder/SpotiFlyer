...
import com.mp3.jaudiotagger.tag.EmptyFrameException;
import com.mp3.jaudiotagger.tag.InvalidDataTypeException;
import com.mp3.jaudiotagger.tag.InvalidFrameException;
import com.mp3.jaudiotagger.tag.InvalidFrameIdentifierException;
import com.mp3.jaudiotagger.tag.id3.framebody.AbstractID3v2FrameBody;
import com.mp3.jaudiotagger.tag.id3.framebody.FrameBodyDeprecated;
import com.mp3.jaudiotagger.tag.id3.framebody.FrameBodyUnsupported;
import com.mp3.jaudiotagger.tag.id3.valuepair.TextEncoding;
import com.mp3.jaudiotagger.utils.EqualsUtil;
...
public class ID3v22Frame extends AbstractID3v2Frame
{
    ...
    public ID3v22Frame(String identifier)
    {
        ...
        try
        {
            Class<AbstractID3v2FrameBody> c = (Class<AbstractID3v2FrameBody>) Class.forName("com.mp3.jaudiotagger.tag.id3.framebody.FrameBody" + bodyIdentifier);
     ...
     * @throws com.mp3.jaudiotagger.tag.InvalidFrameException
     */
