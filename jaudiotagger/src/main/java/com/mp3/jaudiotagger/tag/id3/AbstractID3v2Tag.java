 ...
 */
package com.mp3.jaudiotagger.tag.id3;

import com.mp3.jaudiotagger.StandardCharsets;
import com.mp3.jaudiotagger.audio.AudioFile;
import com.mp3.jaudiotagger.audio.exceptions.UnableToCreateFileException;
import com.mp3.jaudiotagger.audio.exceptions.UnableToModifyFileException;
import com.mp3.jaudiotagger.audio.exceptions.UnableToRenameFileException;
import com.mp3.jaudiotagger.audio.generic.Utils;
import com.mp3.jaudiotagger.audio.mp3.MP3File;
import com.mp3.jaudiotagger.logging.ErrorMessage;
import com.mp3.jaudiotagger.logging.FileSystemMessage;
import com.mp3.jaudiotagger.tag.*;
import com.mp3.jaudiotagger.tag.datatype.DataTypes;
import com.mp3.jaudiotagger.tag.datatype.Pair;
import com.mp3.jaudiotagger.tag.datatype.PairedTextEncodedStringNullTerminated;
import com.mp3.jaudiotagger.tag.id3.framebody.*;
import com.mp3.jaudiotagger.tag.id3.valuepair.ID3NumberTotalFields;
import com.mp3.jaudiotagger.tag.id3.valuepair.StandardIPLSKey;
import com.mp3.jaudiotagger.tag.images.Artwork;
import com.mp3.jaudiotagger.tag.reference.Languages;
import com.mp3.jaudiotagger.tag.reference.PictureTypes;
...
public abstract class AbstractID3v2Tag extends AbstractID3Tag implements Tag
{
    ...
    */
     ...
     *
     * @see com.mp3.jaudiotagger.tag.Tag#hasField(String)
     */
     ...
     * Is this tag empty
     *
     * @see com.mp3.jaudiotagger.tag.Tag#isEmpty()
     */
