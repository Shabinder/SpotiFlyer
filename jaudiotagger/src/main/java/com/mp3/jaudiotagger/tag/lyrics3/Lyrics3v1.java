...
import com.mp3.jaudiotagger.tag.id3.AbstractTag;
import com.mp3.jaudiotagger.tag.id3.ID3Tags;
import com.mp3.jaudiotagger.tag.id3.ID3v1Tag;
...
public class Lyrics3v1 extends AbstractLyrics3
{
    ...
    {
        /**
         * @todo Implement this com.mp3.jaudiotagger.tag.AbstractMP3Tag abstract method
         */
