 ...
 */
package com.mp3.jaudiotagger.tag.datatype;

import com.mp3.jaudiotagger.tag.InvalidDataTypeException;
import com.mp3.jaudiotagger.tag.id3.AbstractTagFrameBody;
import com.mp3.jaudiotagger.tag.id3.valuepair.EventTimingTypes;

/**
 * A single synchronized tempo code. Part of a list of temnpo codes ({@link com.mp3.jaudiotagger.tag.datatype.SynchronisedTempoCodeList}), that are contained in
 * {@link com.mp3.jaudiotagger.tag.id3.framebody.FrameBodySYTC}
 *
